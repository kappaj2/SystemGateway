...
@Component({
    selector: 'jhi-incident-my-suffix',
    templateUrl: './incident-my-suffix.component.html'
})
export class IncidentMySuffixComponent implements OnInit, OnDestroy {

    incidents: IncidentMySuffix[];
    currentAccount: any;
    ...
    trackId(index: number, item: IncidentMySuffix) {
        return item.id;
    }
